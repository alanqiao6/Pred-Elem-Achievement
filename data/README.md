...
| variable                  | class  | description                                                                                                                                                                                                                       |
|---------------------------|--------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| cunty_fips_code           | double | Four- or five-digit number that uniquely identifies the county in a state. The first two digits (for five-digit numbers) or 1 digit (for four-digit numbers) refer to the FIPS code of the state to which the county belongs.     |
...
| variable  | class     | description                                          |
|:---------------|:---------------|:---------------------------------------|
| long      | character | Longitudinal coordinates of point on map             |
| lat       | integer   | Latitudinal coordinates of point on map              |
| group     | integer   | ID tag of coordinates by specific subregion of point |
| order     | symbol    | Higher, lower, or at national public                 |
| region    | character | Region of coordinates (state/district)               |
| subregion | character | Subregion of coordinates (within state/district)     |
