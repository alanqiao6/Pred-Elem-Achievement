...
r_squared <- c(
  summary(regression_model_1)$adj.r.squared, 
...
`r nrow(us_states)` observations. This dataset provides the latitude and
longitude coordinates in order to create the choropleth map base of the
United States for visualizations #1 and #2.
...
low-income neighborhoods to reach economic prosperity. Visualization #3
