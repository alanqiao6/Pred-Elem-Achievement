...
both, one, or no working parents affects reading skills, and since, the
autonomy and support associated with a parent's job has been shown to
predict positive involvement with children, we also hope to investigate
the impact of parents' fields of occupation. Finally, it is necessary to
explore the role of access to both family-based and center-based
child-care given the proven significance of high-quality child-care.

Cross-referencing research with dataset to identify potential factors
...
-   Percent of single-family households Percent of families where both
    parents work vs. where one parent works

-   Distribution of most common occupations of parents
...
#Ratio of two-parent-working to one-parent-working households 
childcare_costs <- childcare_costs |> 
  mutate(
