...
maximum_regression_model <- linear_reg() |>
  fit(MN ~ family_poverty, minority_racial_status, percentage_single_mother, ratio_of_one_to_both, average_center_child_care, average_family_child_care, data = merged_data)
