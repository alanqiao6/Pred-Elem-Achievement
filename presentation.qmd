...
-   Guided by these themes, our project sought to create powerful data visualizations that highlight early educational inequity across the United States as a pressing crisis and employ statistical analysis to identify predictors of early academic success
...
#theme() make legend text size smaller 
```

## Linear Model Literature Review:

-   Behavioral skills influenced by parental monitoring and family stability (EARLY SKILLS AND PREDICTORS... 2016)
...
<!-- -->
```
-   Low-SES families less likely to have experiences to develop skills such as phonological awareness, vocabulary, and oral language (American Psychological Association, 2017)
...
merged_final_data <- merged_final_data |> 
  mutate(
    sector_type = fct_reorder(sector_type, mean_percentage, .desc = TRUE)
  ) |> 
  filter(!is.na(state_name))
...
merged_final_data |> 
  ...
  labs(x = "Year", y = "Population Percentage Employed", title = "Percentage of Population Employed in Sector by State", fill = "Sector") +
  theme_bw() +
...
-   Standardized tests not perfect for aptitude, potential, and achievement measurement
...
"High-quality child care contributes to later success in science, math." American Psychological Association, 15 June 2023, www.apa.org/news/press/releases/2023/06/quality-child-care-science-math#:\~:text=Washington%20%E2%80%94%20Children%20who%20receive%20high,by%20the%20American%20Psychological%20Association. Accessed 6 Dec. 2023.

Perry-Jenkins, Maureen. "How a Parent's Experience at Work Impacts Their Kids." Harvard Business Review, 31 Jan. 2023, hbr.org/2023/01/how-a-parents-experience-at-work-impacts-their-kids#:\~:text=A%20multi%2Dyear%20study%20following,by%20their%20parents%27%20work%20lives.&text=It%27s%20no%20secret%20that%20our,our%20lives%20outside%20of%20work.
